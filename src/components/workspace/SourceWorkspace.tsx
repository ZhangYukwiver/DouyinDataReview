  ...
  return (
    <View testID="setup-workspace" style={styles.root}>
      <View style={[styles.topbar, phone && styles.topbarPhone]}>
        ...
        <View style={styles.topStatus}><View {...fx({ motion: connected ? "pulse" : null })} style={[styles.statusDot, connected && styles.statusDotReady]} /><Text numberOfLines={1} style={styles.statusText}>{busy && ready && snapshotSource === "collector" ? `${source} · 采集中，报告用采集前的数据` : source}</Text></View>
